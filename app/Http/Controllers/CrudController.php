...
class CrudController extends Controller
{
    ...
    public function storeData(Request $request){
        ...
        $crud->save();
        \Illuminate\Support\Facades\Session::flash('msg','Data Successfully Added');
    ...
    public function showJson(){
        return view('api_show');
    }

    public function showJsonPatient(){
        return view('api_create');
    }

    // public function showJsonDelete(){
    //     return view('api_delete');
    // }
}

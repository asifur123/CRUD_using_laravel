...
Route::get('/show-json',[CrudController::class,'showJson']);
Route::get('/show-json-patient',[CrudController::class,'showJsonPatient']);
// Route::post('/show-json-delete',[CrudController::class,'showJsonDelete']);